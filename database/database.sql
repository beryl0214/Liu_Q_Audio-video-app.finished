...
--
-- Host: localhost:8889
-- Generation Time: Apr 19, 2018 at 04:40 AM
...
(15, NULL, 'sdvs', '2018-04-09 20:46:56', 10, 0),
(16, NULL, 'meh', '2018-04-16 23:07:43', 5, 3);
...
INSERT INTO `tbl_movies` VALUES (1,'DETECTIVE_CHINATOWN.jpg','DETECTIVE CHINATOWN','2017','2h 16m','Lured to New York, Qin (Liu Haoran) finds himself in a global detective contest with a huge cash prize. The task: locate the grandson of the godfather of Chinatown. Teaming up with Tang (Wang Baoqiang), the \'Detective Chinatown Duo\' are on the trail - until the missing person case becomes a murder.','DETECTIVE_CHINATOWN.mp4','May 5, 2017'),(2,'Farewell_My_Concubine.jpg','Farewell My Concubine','2017','1h 46m','As the film opens, a street crowd watches a troupe of boys perform Peking opera, supervised by their aging director, Master Guan. When Laizi attempts to run away, Shitou placates the crowd by breaking a brick on his head; the crowd cheers, but Shitou is later punished for the stunt. An onlooking mother brings her son to the troupe to be trained, using a cleaver to amputate her child\'s objectionable superfluous finger, and marking the contract with her thumb print in the blood. Shitou welcomes the newcomer as \" Douzi\" (bean), and the two boys become friends.','Farewell_My_Concubine.mp4','July 21, 2017'),(3,'Duckweed.jpg','Duckweed','2017','2h 17m','The film tells the story about the reconciliation between a father and his son. Ah Lang, a youth from a small town, thinks that his father Ah Zheng never understood his occupation and life. In a fateful occurrence, he is able to experience his father\'s legendary and interesting life in the past.','Duckweed.mp4','March 3,2017'),(4,'Skiptrace.jpg','Skiptrace','2017','2h','Hong Kong detective Bennie Chan (Jackie Chan) has been tracking notorious crime boss \"Matador\" – whom he believes to be businessman Victor Wong (Winston Chao) – for over a decade after the death of Bennie\'s partner Yung (Eric Tsang). When Yung\'s daughter Samantha (Fan Bingbing) gets into trouble with Wong\'s crime syndicate, Bennie must track down an American conman, Connor Watts (Johnny Knoxville), who gambles his way through Chinese casinos after being banned in America and he witnesses the murder of a woman named Esther Yee in Wong\'s Macau casino. However, before Bennie can find him, Connor is kidnapped by a Russian kingpin to answer for leaving his daughter pregnant.','Skiptrace.mp4','June 28,2017'),(5,'Guns_and_Roses.jpg','Guns and Roses','2017','2h 9min','The film is set in the 1930s in Changchun, capital of Manchukuo. A thief, Xiao Dongbei (Lei Jiayin) goes into a cathedral and robs the priest (Fan Wei), claiming that he is a member of the underground revolution. As he is running away, the police capture him. Meanwhile, two rebels go to a cinema to exchange messages, but a witty Japanese colonel, Kōnosuke Toriyama (Keiichi Yamasaki), kills one and captures the other. Xiao Dongbei is given leniency and spends only two days in jail. Sharing a cell with him is the captured rebel, who gives him his clothes as a gift.','Guns_and_Roses.mp4','March 17, 2017'),(6,'hacksaw.jpg','Hacksaw Ridge','2016','2h 19m','WWII American Army Medic Desmond T. Doss, who served during the Battle of Okinawa, refuses to kill people, and becomes the first man in American history to receive the Medal of Honor without firing a shot.','Hacksaw.mp4','November 4, 2016'),(7,'Youth.jpg','Youth','2016','1h 48m','The film chronicles the lives of a group of idealistic adolescents in a military art troupe in the People\'s Liberation Army during the Cultural Revolution. They experience love, lust, betrayal, and sufferings in the background of Mao-era songs and dances. The two key characters, Feng Liu and Xiaoping He, also participate in the Sino-Vietnamese War in 1979 and become heroes for their act of courage. After the war, they are honorably discharged from the Army but struggle to make ends meet in the Reform-era China, while they eventually find their own love separately, grow up to fight against the situations like the Cultural Revolution, and even learnt lessons from soul-crashing experiences of love, lust, betrayal, and sufferings in the background of Mao-era. The film shows the real stories happened in reality by art, and the Cultural Revolution is a crazy era which is full of personal political attacks and entire world has been taking all efforts to avoid.','Youth.mp4','Febuary 12, 2016'),(8,'The_Flowers_of_War.jpg','The Flowers of War','2016','1h 56m','In 1937, Japan invades China, beginning the Second Sino-Japanese War. The Japanese Imperial Army overruns China\'s capital city, Nanking, in December and carries out the systematic and brutal Nanking massacre.','The_Flowers_of_War.mp4','November 11, 2016'),(9,'1942.jpg','1942','2016','1h 46m','The film is set in Henan, China in the winter of 1942, during the Second Sino-Japanese War. Master Fan is a wealthy landlord in a village in Henan. When the village is suffering from famine, Fan still has plenty of food to feed his family and the villagers. A group of bandits come and rob the village, eventually burning it down to the ground. Fan\'s son dies in the process of stopping the bandits.','1942.mp4','Febuary 26, 2016'),(10,'Cold_War_poster.jpg','Cold War','2016','1h 32m','One midnight, a Hong Kong Police Force Emergency Unit (EU) van carrying advanced equipment and five police officers goes missing. As the police investigate the case, they became aware that the terrorists possess detailed knowledge of the police\'s procedures and have planned several steps ahead, even possibly breaching the secured police network. As the Commissioner is away, Deputy Commissioner M.B. Lee (Tony Leung Ka-fai), plans and leads a rescue operation code-named \"Cold War,\" and declares Hong Kong to go under a state of emergency.','Cold_War_poster.mp4','November 4, 2016'),(22,'Kingsman_The_Golden_Circle.jpg','Kingsman','2017','2h13m','A year after the events of the previous film, Eggsy Unwin has officially joined Kingsman, taken his late mentor Harry Hart\'s title of Galahad and begun a relationship with Tilde, Crown Princess of Sweden. On his way home from the tailor shop, he is ambushed by Charlie Hesketh, a former Kingsman trainee who lost his arm and vocal cords during the Valentine incident, replacing them with cybernetics. Eggsy evades Charlie and his henchmen in a car chase across London, but Charlie\'s severed cybernetic arm hacks into the Kingsman servers through the computer system of Eggsy\'s car. Charlie passes on the information gained to Poppy Adams, the leader of the world\'s largest drug cartel, the Golden Circle. Poppy uses the information to launch a volley of missiles that destroy the Kingsman headquarters and wipe out all of the agents in Britain, aside from Eggsy and Merlin, Kingsman\'s tech support.','Kingsman_The_Golden_Circle.mp4','');
...
--
ALTER TABLE `tbl_comments`
  MODIFY `comments_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
